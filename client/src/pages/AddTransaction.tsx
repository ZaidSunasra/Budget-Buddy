...
const { handleSubmit, register, formState: { errors, isSubmitting } } = useForm<expenseInput>();
...
return <div className="w-screen h-screen flex justify-center items-center font-mono">
    <form onSubmit={handleSubmit(onSubmit)} className="w-1/3 p-8 border-primary border rounded-2xl bg-accent shadow-2xl ">
        <h3 className="text-center text-2xl mb-4 font-bold"> Add Transaction </h3>
        <div className="mb-4">
            <Label> Title</Label>
        ...
        <Button className="w-full" disabled={isSubmitting}>Add Transaction </Button>
    </form>
</div>
}
