...
export const sortByCategoryController = async (
  req: Request,
  res: Response,
): Promise<any> => {
...
export const monthlyAnalyticsController = async (
  req: Request,
  res: Response,
): Promise<any> => {
  const id = res.locals.id;
...
export const yearlyAnalyticsController = async (
  req: Request,
  res: Response,
): Promise<any> => {
  const id = res.locals.id;
...
export const currentMonthAnalysisController = async (
  req: Request,
  res: Response,
): Promise<any> => {
  const id = res.locals.id;
